...
// Elysium Client
MACRO_CONFIG_INT(ClElysiumEnabled, cl_elysium_enabled, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Elysium client features")
MACRO_CONFIG_INT(ClElysiumShowLogo, cl_elysium_show_logo, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show Elysium logo")
MACRO_CONFIG_INT(ClElysiumShowNotifications, cl_elysium_show_notifications, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show Elysium status notifications")
MACRO_CONFIG_INT(ClElysiumShowServerTags, cl_elysium_show_server_tags, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show Elysium server tags")
MACRO_CONFIG_INT(ClElysiumHighlightServers, cl_elysium_highlight_servers, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Highlight Elysium servers in the server browser")
MACRO_CONFIG_INT(ClElysiumOnlyServers, cl_elysium_only_servers, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show only Elysium servers in the server browser")
MACRO_CONFIG_INT(ClElysiumAutoServerFilter, cl_elysium_auto_server_filter, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply the Elysium server filter automatically")
MACRO_CONFIG_INT(ClElysiumConnectionNotifications, cl_elysium_connection_notifications, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show connection notifications")
MACRO_CONFIG_INT(ClElysiumUpdateNotifications, cl_elysium_update_notifications, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show update notifications")
MACRO_CONFIG_INT(ClElysiumSystemNotifications, cl_elysium_system_notifications, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show system messages")
MACRO_CONFIG_INT(ClElysiumCheckUpdates, cl_elysium_check_updates, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Check for updates on startup")

// Elysium UI theme
MACRO_CONFIG_INT(ClElysiumUi, cl_elysium_ui, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable the Elysium UI theme")
MACRO_CONFIG_INT(ClElysiumUiScale, cl_elysium_ui_scale, 100, 50, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Elysium UI scale in percent")
MACRO_CONFIG_INT(ClElysiumAnimations, cl_elysium_animations, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Elysium UI animations")
MACRO_CONFIG_INT(ClElysiumReduceAnimations, cl_elysium_reduce_animations, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Reduce Elysium UI animations")
MACRO_CONFIG_INT(ClElysiumTransparentPanels, cl_elysium_transparent_panels, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Use transparent Elysium panels")
MACRO_CONFIG_INT(ClElysiumCompactServerList, cl_elysium_compact_server_list, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Use a compact server list layout")
MACRO_CONFIG_INT(ClElysiumCompactChat, cl_elysium_compact_chat, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Use a compact chat layout")
MACRO_CONFIG_INT(ClElysiumTooltips, cl_elysium_tooltips, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show Elysium UI tooltips")
MACRO_CONFIG_INT(ClElysiumHighContrast, cl_elysium_high_contrast, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Elysium high-contrast mode")
